...
public class SnufflesBlocks {
    ...
    public static final RegistryObject<Block> SNUFFLE_FLUFF = BLOCKS.register("snuffle_fluff", () -> new SnuffleFluffBlock(BlockBehaviour.Properties.of(Material.WOOL, MaterialColor.SNOW).strength(0.6F).sound(SoundType.WOOL)));
